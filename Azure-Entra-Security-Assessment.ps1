...
# Essential 8 compliance tracking
...
# ===== ESSENTIAL 8 SECURITY FRAMEWORK ASSESSMENTS =====
...
function Test-Essential8-ApplicationControl {
    ...
    try {
        ...
        if ($consentPolicy) {
            ...
            $script:Essential8Results.ApplicationControl += "Application consent policies configured"
        } else {
            ...
            $script:Essential8Results.ApplicationControl += "No application consent policies configured"
        }
